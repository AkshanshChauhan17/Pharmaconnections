    ...
    <footer className="footer">
      <div className="footer-top">
        <div className="footer-column about">
          <a
            href="https://pharmaconnections.in"
            target="_blank"
            rel="noreferrer"
          >
            <img
        ...
        <div className="footer-column contact">
          ...
          <div className="contact-info">
            <p>
              <strong>Phone:</strong>{" "}
              <a href="tel:+918660877518">+91 86608-77518</a>
            </p>
            <p>
              <strong>Mail Us:</strong>{" "}
              <a href="mailto:info@pharmaconnections.in">
                info@pharmaconnections.in
              </a>
            </p>
          </div>
        </div>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-bottom-links">
          <a
            href="https://pharmaconnections.in/terms-of-use/"
            target="_blank"
            rel="noreferrer"
          >
            Terms Of Use
          ...
          <span>|</span>
          <a
            href="https://pharmaconnections.in/privacy-policy/"
            target="_blank"
            rel="noreferrer"
          >
            Privacy Policy
